...
export const igdbGames = pgTable('igdb_games', {
...
export const igdbCovers = pgTable('igdb_covers', {
	id: bigint('id', { mode: 'number' }).primaryKey(),
	url: text('url'),
	...
	deletedAt: timestamp('deleted_at', { withTimezone: true }),
		...
		index('igdb_covers_game_idx').on(t.game),
	])
...
export const igdbInvolvedCompanies = pgTable('igdb_involved_companies', {
	id: bigint('id', { mode: 'number' }).primaryKey(),
	createdAt: timestamp('created_at', { withTimezone: true }),
	updatedAt: timestamp('updated_at', { withTimezone: true }),
	game: bigint('game', { mode: 'number' }),
...
export const igdbWebsites = pgTable('igdb_websites', {
	id: bigint('id', { mode: 'number' }).primaryKey(),
	url: text('url'),
	...
	deletedAt: timestamp('deleted_at', { withTimezone: true }),
		...
		index('igdb_websites_game_idx').on(t.game),
	])

export const igdbExternalGames = pgTable('igdb_external_games', {
	id: bigint('id', { mode: 'number' }).primaryKey(),
	name: text('name'),
	createdAt: timestamp('created_at', { withTimezone: true }),
	updatedAt: timestamp('updated_at', { withTimezone: true }),
...
export const igdbAlternativeNames = pgTable('igdb_alternative_names', {
	id: bigint('id', { mode: 'number' }).primaryKey(),
	name: text('name'),
	...
	deletedAt: timestamp('deleted_at', { withTimezone: true }),
		...
		index('igdb_alternative_names_game_idx').on(t.game),
	])

export const igdbGameLocalizations = pgTable('igdb_game_localizations', {
	id: bigint('id', { mode: 'number' }).primaryKey(),
	name: text('name'),
	cover: bigint('cover', { mode: 'number' }),
	game: bigint('game', { mode: 'number' }),
	...
	deletedAt: timestamp('deleted_at', { withTimezone: true }),
		...
		index('igdb_game_localizations_game_idx').on(t.game),
	])
